...
export default function AskQuestionPage() {
  ...
  useEffect(() => {
    fetch("http://localhost:8080/api/questions/tags/all")
      .then(res => res.json())
  ...
  }, [formKey]); // <-- Make this effect run on every reset!
        ...
        <div className="col-lg-8">
            ...
            <div className="card-body">
              ...
              <input
                ...
                className={`form-control ${
                  touched && errors.title ? "is-invalid" : ""
                }`}
          ...
          <div className="card shadow-sm mb-3">
            <div className="card-body">
              ...
              />
              <div className="form-text">
                Include details, what you tried, expected vs actual results, and minimal reproducible example.
              </div>
              {touched && errors.body && (
          ...
          <div className="card shadow-sm mb-3">
            <div className="card-body">
              ...
              />
              <div className="form-text">
                Add up to {TAGS_MAX} tags to describe what your question is about.
              </div>
              {touched && errors.tags && (
